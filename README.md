...
| **Preparado por**                            | Yeira Shari Huaman Olivos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Participantes (reunión de planificación)** | - Yeira Shari Huaman Olivos <br> - Keyner Ivan Hancco Poma <br> - Gabriela Luciana Tirado Carrera <br> - Diego Ismael Guevara Serrano <br> - Moscoso Bejar Angelo Stephano                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Sprint Goal & User Stories**               | El enfoque se centró en brindar funcionalidades que permitan a los usuarios gestionar y monitorear su consumo de agua dentro de la plataforma HydroSmart. Esto busca mejorar la experiencia al facilitar la visualización, control y actualización de la información de consumo de manera clara y eficiente. El resultado esperado es que los usuarios puedan interactuar con estos datos de forma fluida, sin errores y con una comprensión sencilla de su consumo. |
...
| Segmento objetivo #1: Propietarios de Viviendas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                       |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|
| **Link:** https://shorturl.at/4V6zq                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                       |
| **Entrevista 1:** Yusnury Vivar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                       |
| **Sexo:** Femenino                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | **Edad**: 30                          |
| **Instante en el que inicia:**              0 minutos y 0 segundos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | **Duración:** 4 minutos y 41 segundos |
| **Imagen del entrevistado:**<br>![imagen_yus](./images/Yus-Entrevista.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |                                       |
| **Resumen de la entrevista:**<br>La entrevistada, Yusnury Vivar, de 30 años, compartió observaciones relevantes tras explorar el prototipo de la aplicación HydroSmart (AquaPulse). En primer lugar, indicó que la propuesta le resultó atractiva y fácil de comprender, destacando que la navegación del sistema presenta una estructura clara que permite identificar rápidamente las funcionalidades principales, como el dashboard, la visualización del consumo de agua y la gestión de dispositivos. Asimismo, señaló que le llamó especialmente la atención la posibilidad de monitorear en tiempo real el uso de agua dentro de su hogar, así como recibir alertas ante anomalías o posibles fugas, lo cual considera de gran utilidad para evitar gastos innecesarios. En general, la percepción de la entrevistada fue positiva, señalando que sí utilizaría AquaPulse debido a los beneficios que ofrece, especialmente en cuanto a la visualización clara de datos en el dashboard y la detección temprana de consumos inusuales. No obstante, como oportunidad de mejora, sugirió que la plataforma podría incorporar elementos visuales más dinámicos o didácticos que faciliten aún más la interpretación de la información, haciendo la experiencia más intuitiva y accesible para todo tipo de usuarios. |                                       |
